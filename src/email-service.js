...
/**
 * Email Service for CurrForge
 * Sends curriculum PDFs to users via Hostinger SMTP
 */
...
function createTransporter() {
    return nodemailer.createTransport({
        ...
        secure: true, // Use SSL
        auth: {
            user: process.env.SMTP_USER, // Your Hostinger email (e.g., noreply@currforge.com)
...
async function sendCurriculumEmail({ email, context, results }) {
    try {
        ...
        const mailOptions = {
            from: {
                name: process.env.SMTP_FROM_NAME || 'CurrForge',
